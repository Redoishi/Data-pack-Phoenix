...
| **- Coral** |
| coral_fan/*                | ![craft](img/coral_fan.png)               | :x:                 | All coral / dead coral |
| coral_plants/from_fan/*    | ![craft](img/coral_plant_from_fan.png)    | :x:                 | All coral / dead coral |
| coral_plants/from_blocks/* | ![craft](img/coral_plant_from_blocks.png) | :x:                 | All coral / dead coral |
| coral_blocks/*             | ![craft](img/coral_blocks.png)            | :heavy_check_mark:  | All coral / dead coral |
